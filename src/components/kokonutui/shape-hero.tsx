    ...
    <div className="relative flex min-h-screen pt-40 w-full items-center justify-center overflow-hidden bg-white dark:bg-[#030303]">
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            {eyebrow ? (
              <p className="mb-4 text-xs font-semibold uppercase tracking-[0.3em] text-black/40 dark:text-white/50">
                {eyebrow}
              </p>
            ) : null}
            <h1 className="mb-6 font-bold text-4xl tracking-tight sm:text-6xl md:mb-8 md:text-8xl">
              ...
              <span className="block">
                ...
                {titleContinuation ? (
                  <span className="bg-linear-to-b from-black to-black/70 bg-clip-text text-transparent dark:from-white dark:to-white/70">
                    {titleContinuation}
                  </span>
                ) : null}
              </span>
